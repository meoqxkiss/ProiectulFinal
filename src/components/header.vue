<template>
  <header>
    <div class="logo">
      <router-link to="/"><h1>Adoptă&Ajută</h1></router-link>
    </div>
    <nav class="navigation">
      <ul>
        <li><router-link to="/">Home</router-link></li>
        <li><router-link to="/success">Success Stories</router-link></li>
...
header {
  background-color: #708871; /* Pastel green background */
  display: flex;
  justify-content: center; /* Center items horizontally */
  align-items: center; /* Center items vertically */
  padding: 20px; /* Added padding for better alignment */
  position: relative; /* Position relative for alignment tweaks */
}
